...
SELECT "first_name" AS "First", "last_name" AS "Last", "birth_city" AS "Hometown", "birth_country" AS "Country"
FROM "players"
WHERE "birth_country" = 'P.R.'
ORDER BY "first_name" ASC, "last__name" ASC;
